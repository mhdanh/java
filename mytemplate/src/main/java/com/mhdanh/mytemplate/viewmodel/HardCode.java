...
public class HardCode {
	public static final String topDownload = "top-download";
	public static final String topFreeDownload = "top-free-download";
	...
	public static final String adminMail = "maidanhcongtu@gmail.com";
}
